<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="#_" onclick="location.href='{{ route('main') }}'" class="w-1 box-border relative z-2 inline-flex items-center justify-center mx-4 my-1 px-8 py-3 overflow-hidden font-bold text-white transition-all duration-300 bg-teal-600 rounded-md cursor-pointer group ring-offset-2 ring-1 ring-teal-300 ring-offset-teal-200 hover:ring-offset-teal-500 ease focus:outline-none">
